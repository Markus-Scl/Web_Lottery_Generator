...
export class LotteryDrawPageComponent {
  ...
  async drawNumbersFiveFromFifty(){
    if(!this.lotteryDrawingRunning){

      this.lotteryDrawingRunning = true;
      this.seeHeadline = false;
      ...
      this.displayedFiveNumbers = [];
      this.displayedTwoNumbers = [];
      ...
      this.lotteryDrawingRunning = false;
    }
  }
}
